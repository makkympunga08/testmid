...
<head>
    ...
    <title>Courses by Semester and Department</title>
...
<a class="home-link" href="index.jsp"><span></span><span></span><span></span><span></span>DashBoard</a>
    <h1>Courses by Semester and Department</h1>
    
    <form method="post" action="<%= request.getRequestURI() %>">
        Enter Semester: <input type="text" name="semesterName"><br>
    ...
    <table border="1">
        ...
        <%
            ...
            if (requestedSemester != null && requestedDepartment != null) {
                ...
                List<Course> courses = em.createQuery("SELECT c FROM Course c WHERE c.semester = :semester AND c.department = :department", Course.class)
